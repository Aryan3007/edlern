          ...
          <div className="grid items-center grid-cols-1 gap-12 lg:grid-cols-2">
            <div>
             ...
             <div className="flex flex-col mt-6 gap-4 sm:flex-row">
               <button className="inline-flex shadow-xl gap-2 w-fit items-center px-6 py-3  font-semibold text-white transition-all duration-200 bg-gradient-to-br from-sky-500 to-sky-600 rounded-full lg:mt-16 hover:bg-sky-500/80 focus:bg-sky-500/60" role="button">
                Create Community
                <ChevronRight />
              </button>
